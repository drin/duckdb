...
namespace duckdb {
  ...
  struct ArrowScanLocalState : public LocalTableFunctionState {
	...
	struct ArrowTableFunction {
		...
		//! Binds an arrow table
		static unique_ptr<FunctionData>
		ArrowScanBindDumb( ClientContext&          context
		                  ,TableFunctionBindInput& input
		                  ,vector<LogicalType>&    return_types
		                  ,vector<string>&         names);
		...
		static void
		ArrowToDuckDB( ArrowScanLocalState&      scan_state
		...
		//! Get next scan state
		static bool
		ArrowScanParallelStateNext( ClientContext&        context
